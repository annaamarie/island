...
desired_fields = [
    # Top countries
    "obj.top_countries[0].name",  # ig_top_1_country_name
    "obj.top_countries[0].code",  # ig_top_1_country_code
    "obj.top_countries[0].percent",  # ig_top_1_country_percent
    "obj.top_countries[0].followers",  # ig_top_1_country_followers
    "obj.top_countries[1].name",  # ig_top_2_country_name
    "obj.top_countries[1].code",  # ig_top_2_country_code
    "obj.top_countries[1].percent",  # ig_top_2_country_percent
    "obj.top_countries[1].followers",  # ig_top_2_country_followers
    "obj.top_countries[2].name",  # ig_top_3_country_name
    "obj.top_countries[2].code",  # ig_top_3_country_code
    "obj.top_countries[2].percent",  # ig_top_3_country_percent
    "obj.top_countries[2].followers",  # ig_top_3_country_followers
    # Age stats
    ...
    # Other stats
    "obj.followers",  # ig_followers
    "obj.avg_likes_per_post",  # ig_avg_likes_per_post
    "obj.avg_comments_per_post",  # ig_avg_comments_per_post
    "obj.engagement_rate"  # ig_engagement_rate
]
...
root_path = "ch_artist_ig_audience_data"
